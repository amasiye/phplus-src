...
- Typed locals, typed loop bindings, strict project analysis, and checked errors are active. Keep generics, typed arrays, and when inactive until their assigned stages.
