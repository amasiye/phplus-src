    ...
    public array $all {
        get {
            $capabilities = [
                ...
                $this->capability('interop.builtin-signatures', 'Broad PHP built-in signatures', CapabilityCategory::Interoperability, CapabilityRequirement::Boundary, CompilerCoverage::BackendOnly, SupplementalCoverage::Complete, [Code::ArgumentTypeDoesNotMatch], 'interop-builtin-signatures', 'Broad target-version core and extension signatures remain the Stage 13C portable declaration-package boundary.', '13c-builtin-signature-package'),
